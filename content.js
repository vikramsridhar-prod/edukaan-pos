...
const COPY = {
  en: {
    ...
    base: {
      ...
      featTitle: 'Everything your store needs, in one screen.',
  ...
  ar: {
    ...
    base: {
      ...
      featTitle: 'كل ما يحتاجه متجرك، في شاشة واحدة.',
...
const DATA = {
  en: {
    ...
    features: {
      AE: [
        { title: 'Fast checkout', body: 'Scan, weigh, discount, bundle. Reprint any receipt in a tap.', cardTitle: 'Checkout', rows: [{ k: 'Items', v: '14' }, { k: 'Scan speed', v: '< 1 sec' }, { k: 'Discount', v: 'Buy 2 get 1' }], action: 'Charge AED 120.23' },
        { title: 'Every way to pay', body: 'Cash, card, Tabby, Tamara, gift cards and split payments.', cardTitle: 'Payment', rows: [{ k: 'Card', v: 'AED 60.00' }, { k: 'Cash', v: 'AED 60.23' }, { k: 'Change', v: 'AED 0.00' }], action: 'Complete sale' },
        { title: 'Live inventory', body: 'Stock updates with every sale, across every branch.', cardTitle: 'Stock · Al Ain 500ml', rows: [{ k: 'Al Barsha', v: '6 left' }, { k: 'Al Nahda', v: '48' }, { k: 'Alert', v: 'Reorder' }], action: 'Transfer 24 units' },
        { title: 'Marketplaces', body: 'Amazon, Noon and Tradeling orders from the same stock.', cardTitle: 'Orders today', rows: [{ k: 'In-store', v: '47' }, { k: 'Amazon.ae', v: '9' }, { k: 'Noon', v: '6' }], action: 'Print pick list' },
        { title: 'Loyalty & CRM', body: 'Know your regulars. Points, history, WhatsApp offers.', cardTitle: 'Customer', rows: [{ k: 'Visits', v: '31' }, { k: 'Points', v: '1,240' }, { k: 'Last', v: 'Yesterday' }], action: 'Send offer' },
        { title: 'UAE VAT, handled', body: 'FTA tax invoices and tourist VAT refunds, automatic.', cardTitle: 'Tax invoice', rows: [{ k: 'TRN', v: '100 2345 6789' }, { k: 'VAT 5%', v: 'AED 5.73' }, { k: 'Tourist refund', v: 'Eligible' }], action: 'Issue invoice' },
      ],
      SA: [
        { title: 'IMEI tracking', body: 'Every handset scanned in and out. No mystery stock.', cardTitle: 'Device', rows: [{ k: 'Model', v: 'iPhone 16' }, { k: 'IMEI', v: '3542 …221' }, { k: 'Warranty', v: '24 months' }], action: 'Sell device' },
        { title: 'Warranty & repairs', body: 'Warranty registration and repair tickets in the same till.', cardTitle: 'Repair #8812', rows: [{ k: 'Issue', v: 'Screen crack' }, { k: 'Estimate', v: 'SAR 1,450' }, { k: 'Status', v: 'In progress' }], action: 'Complete repair' },
        { title: 'mada, BNPL, split', body: 'mada, STC Pay, cards, Tabby and Tamara instalments.', cardTitle: 'Payment', rows: [{ k: 'Tamara ×4', v: 'SAR 890.50' }, { k: 'mada', v: 'SAR 0.00' }, { k: 'Approval', v: 'Instant' }], action: 'Complete sale' },
        { title: 'ZATCA Phase 2', body: 'Fatoora e-invoices with QR, cleared and reported automatically.', cardTitle: 'E-invoice', rows: [{ k: 'Type', v: 'Simplified' }, { k: 'QR', v: 'Generated' }, { k: 'ZATCA', v: 'Reported ✓' }], action: 'Print invoice' },
        { title: 'Marketplaces', body: 'Amazon.sa, Noon and Tradeling orders from the same stock.', cardTitle: 'Orders today', rows: [{ k: 'In-store', v: '63' }, { k: 'Amazon.sa', v: '12' }, { k: 'Noon', v: '8' }], action: 'Print pick list' },
        { title: 'Multi-branch', body: 'Riyadh, Jeddah, Dammam on one dashboard, with roles.', cardTitle: 'Today · all branches', rows: [{ k: 'Olaya', v: 'SAR 51.2K' }, { k: 'Al Rawdah', v: 'SAR 29.8K' }, { k: 'Dammam', v: 'SAR 22.1K' }], action: 'View report' },
      ],
    },
  ...
  ar: {
    ...
    features: {
      AE: [
        { title: 'بيع سريع', body: 'امسح، وزّن، خصّم، اجمع. أعد طباعة أي فاتورة بضغطة.', cardTitle: 'الكاشير', rows: [{ k: 'الأصناف', v: '14' }, { k: 'سرعة المسح', v: '< ثانية' }, { k: 'خصم', v: 'اشترِ 2 واحصل على 1' }], action: 'تحصيل 120.23 د.إ' },
        { title: 'كل طرق الدفع', body: 'نقد، بطاقة، تابي، تمارا، بطاقات هدايا، ودفع مقسّم.', cardTitle: 'الدفع', rows: [{ k: 'بطاقة', v: '60.00 د.إ' }, { k: 'نقد', v: '60.23 د.إ' }, { k: 'الباقي', v: '0.00 د.إ' }], action: 'إتمام البيع' },
        { title: 'مخزون مباشر', body: 'يتحدث المخزون مع كل عملية بيع وفي كل فرع.', cardTitle: 'المخزون · مياه العين', rows: [{ k: 'البرشاء', v: '6 متبقية' }, { k: 'النهدة', v: '48' }, { k: 'تنبيه', v: 'أعد الطلب' }], action: 'تحويل 24 وحدة' },
        { title: 'المتاجر الإلكترونية', body: 'طلبات أمازون ونون وتريدلينج من المخزون نفسه.', cardTitle: 'طلبات اليوم', rows: [{ k: 'المحل', v: '47' }, { k: 'أمازون', v: '9' }, { k: 'نون', v: '6' }], action: 'طباعة قائمة التجهيز' },
        { title: 'الولاء والعملاء', body: 'اعرف زبائنك. نقاط، سجل، وعروض واتساب.', cardTitle: 'العميل', rows: [{ k: 'الزيارات', v: '31' }, { k: 'النقاط', v: '1,240' }, { k: 'آخر زيارة', v: 'أمس' }], action: 'إرسال عرض' },
        { title: 'ضريبة الإمارات، مضبوطة', body: 'فواتير ضريبية معتمدة واسترداد للسياح، تلقائياً.', cardTitle: 'فاتورة ضريبية', rows: [{ k: 'الرقم الضريبي', v: '100 2345 6789' }, { k: 'ضريبة 5%', v: '5.73 د.إ' }, { k: 'استرداد السياح', v: 'مؤهل' }], action: 'إصدار الفاتورة' },
      ],
      SA: [
        { title: 'تتبع IMEI', body: 'كل جهاز يُمسح عند الدخول والخروج. لا مخزون مجهول.', cardTitle: 'الجهاز', rows: [{ k: 'الموديل', v: 'آيفون 16' }, { k: 'IMEI', v: '3542 …221' }, { k: 'الضمان', v: '24 شهراً' }], action: 'بيع الجهاز' },
        { title: 'الضمان والصيانة', body: 'تسجيل الضمان وتذاكر الصيانة من الكاشير نفسه.', cardTitle: 'صيانة #8812', rows: [{ k: 'المشكلة', v: 'كسر شاشة' }, { k: 'التقدير', v: '1,450 ر.س' }, { k: 'الحالة', v: 'جارٍ' }], action: 'إتمام الصيانة' },
        { title: 'مدى، تقسيط، مقسّم', body: 'مدى، STC Pay، البطاقات، وتقسيط تابي وتمارا.', cardTitle: 'الدفع', rows: [{ k: 'تمارا ×4', v: '890.50 ر.س' }, { k: 'مدى', v: '0.00 ر.س' }, { k: 'الموافقة', v: 'فورية' }], action: 'إتمام البيع' },
        { title: 'فاتورة المرحلة الثانية', body: 'فواتير إلكترونية مع QR، تُعتمد وتُبلَّغ تلقائياً.', cardTitle: 'فاتورة إلكترونية', rows: [{ k: 'النوع', v: 'مبسطة' }, { k: 'QR', v: 'تم الإنشاء' }, { k: 'الهيئة', v: 'تم الإبلاغ ✓' }], action: 'طباعة الفاتورة' },
        { title: 'المتاجر الإلكترونية', body: 'طلبات أمازون السعودية ونون وتريدلينج من المخزون نفسه.', cardTitle: 'طلبات اليوم', rows: [{ k: 'المحل', v: '63' }, { k: 'أمازون', v: '12' }, { k: 'نون', v: '8' }], action: 'طباعة قائمة التجهيز' },
        { title: 'عدة فروع', body: 'الرياض وجدة والدمام في لوحة واحدة، مع صلاحيات.', cardTitle: 'اليوم · كل الفروع', rows: [{ k: 'العليا', v: '51.2 ألف ر.س' }, { k: 'الروضة', v: '29.8 ألف ر.س' }, { k: 'الدمام', v: '22.1 ألف ر.س' }], action: 'عرض التقرير' },
      ],
    },
