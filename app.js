...
(function () {
  ...
  const state = { country: null, lang: null, openFaq: -1, feat: 0, regionOpen: false, tick: 0 };
    ...
    <div class="wrap hero">
      <div class="stack hero-copy">
        <div class="tags">
          ...
          <span class="tag white">${esc(t.countryTag)}</span>
        </div>
        <div class="pos-line">${esc(t.posLine)}</div>
